              ...
              dangerouslySetInnerHTML={{
                __html: `
                  ...
                  * {
                  ...
                  html.dark-theme [style*="background-color:rgba(248,246,240"],
                  html.dark-theme [style*="background-color: rgb(252, 251, 247)"],
                  html.dark-theme [style*="background-color:rgba(252,251,247"],
                  html.dark-theme [style*="background-color: rgb(251, 249, 244)"],
                  html.dark-theme [style*="background-color:rgba(251,249,244"],
                  ...
                  /* White Cards to Dark Obsidian Surfaces */
                  html.dark-theme [style*="background-color: rgb(255, 255, 255)"],
                  html.dark-theme [style*="background-color:rgba(255,255,255"],
                  ...
                  html.dark-theme [style*="background-color: rgb(248, 250, 252)"],
                  html.dark-theme [style*="background-color:rgba(248,250,252"],
                  html.dark-theme [style*="background-color: rgb(241, 245, 249)"],
                  html.dark-theme [style*="background-color:rgba(241,245,249"],
                  html.dark-theme [style*="background-color: rgb(238, 240, 249)"],
                  html.dark-theme [style*="background-color:rgba(238,240,249"],
                  html.dark-theme [style*="background-color: #F8FAFC"],
                  html.dark-theme [style*="background-color: #F1F5F9"],
                  html.dark-theme [style*="background-color: #EEF0F9"],
                  html.dark-theme [style*="background-color:#F8FAFC"],
                  html.dark-theme [style*="background-color:#F1F5F9"],
                  html.dark-theme [style*="background-color:#EEF0F9"] {
                  ...
                  /* Primary Text */
                  html.dark-theme [style*="color: rgb(15, 23, 42)"],
                  html.dark-theme [style*="color:rgba(15,23,42"],
                  html.dark-theme [style*="color: rgb(16, 24, 40)"],
                  html.dark-theme [style*="color:rgba(16,24,40"],
                  html.dark-theme [style*="color: #0F172A"],
                  html.dark-theme [style*="color: #101828"],
                  html.dark-theme [style*="color:#0F172A"],
                  html.dark-theme [style*="color:#101828"] {
                    color: #F8FAFC !important;
                  }

                  /* Muted and Subtitle Text */
                  html.dark-theme [style*="color: rgb(100, 116, 139)"],
                  html.dark-theme [style*="color:rgba(100,116,139"],
                  html.dark-theme [style*="color: rgb(102, 112, 133)"],
                  html.dark-theme [style*="color:rgba(102,112,133"],
                  html.dark-theme [style*="color: rgb(71, 85, 105)"],
                  html.dark-theme [style*="color:rgba(71,85,105"],
                  html.dark-theme [style*="color: #64748B"],
                  html.dark-theme [style*="color: #667085"],
                  ...
                  /* Borders */
                  html.dark-theme [style*="border-color: rgb(226, 232, 240)"],
                  html.dark-theme [style*="border-color:rgba(226,232,240"],
                  html.dark-theme [style*="border-color: rgb(228, 231, 236)"],
                  html.dark-theme [style*="border-color:rgba(228,231,236"],
                  html.dark-theme [style*="border-color: #E2E8F0"],
                  html.dark-theme [style*="border-color: #E4E7EC"],
                  html.dark-theme [style*="border-color:#E2E8F0"],
                  html.dark-theme [style*="border-color:#E4E7EC"] {
                    border-color: #24324D !important;
                  }
